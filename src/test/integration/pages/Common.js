sap.ui.define([
    ...
    function getFrameUrl (sHash, sUrlParameters) {
        var sUrl = jQuery.sap.getResourcePath("hotel/ui5/app", ".html");
        sHash = sHash || "";
    ...
    return Opa5.extend("hotel.ui5.test.integration.pages.Common", {
        ...
        getMockServer : function () {
            return new Promise(function (success) {
                Opa5.getWindow().sap.ui.require(["hotel/ui5/localService/mockserver"], function (mockserver) {
